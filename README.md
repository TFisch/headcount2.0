...
This application is focused on Test Driven Development through the ultilization of Jest and Enzyme. It was initialized using the `create-react-app` boilerplate. Standing issues and further development notes can be found [link to headcount2.0 waffle.io](https://waffle.io/TFisch/headcount2.0 "here").
